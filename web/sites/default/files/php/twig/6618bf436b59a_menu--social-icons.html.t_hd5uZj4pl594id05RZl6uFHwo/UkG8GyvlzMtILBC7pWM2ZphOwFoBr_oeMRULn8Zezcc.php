...
/* themes/villaagency/templates/menu/menu--social-icons.html.twig */
class __TwigTemplate_8d442a5b5da5377085487010b45086f7 extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        try {
            ...
            if (($context["items"] ?? null)) {
                ...
                if ((($context["menu_level"] ?? null) == 0)) {
                    // line 35
                    echo "      <ul";
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [0 => "social-links"], "method", false, false, true, 35), 35, $this->source), "html", null, true);
                    echo ">
    ";
                } else {
                    // line 37
    ...
    ";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                    ...
                    echo "      ";
                    // line 41
                    $context["classes"] = [0 => "fab", 1 => twig_get_attribute($this->env, $this->source,                     // line 43
$context["item"], "title", [], "any", false, false, true, 43)];
                    // line 46
                    echo "
      <li";
                    // line 47
  ...
  ";
    ...
    {
        return "themes/villaagency/templates/menu/menu--social-icons.html.twig";
    }
    ...
    {
        return array (  122 => 55,  115 => 53,  109 => 51,  107 => 50,  102 => 49,  98 => 47,  95 => 46,  93 => 43,  92 => 41,  90 => 40,  85 => 39,  81 => 37,  75 => 35,  72 => 34,  69 => 33,  66 => 32,  51 => 31,  44 => 29,  41 => 24,  39 => 23,);
    }
...
{% macro menu_links(items, attributes, menu_level) %}
  ...
  {% if items %}
    {% if menu_level == 0 %}
      <ul{{ attributes.addClass('social-links') }}>
    {% else %}
      <ul>
    {% endif %}
    {% for item in items %}
      ...
      <li{{ item.attributes }}>
        ...
        <a href=\"#\"><i {{ attributes.addClass(classes) }}></i></a>
        {% if item.below %}
  ...
  {% endif %}
{% endmacro %}
", "themes/villaagency/templates/menu/menu--social-icons.html.twig", "/app/web/themes/villaagency/templates/menu/menu--social-icons.html.twig");
    }
